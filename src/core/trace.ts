...
// alarmed, never blocking — provenance is observation, and observation
// never blocks the request path (roadmap 4.1).
export interface IAnswerTraceWriter {
  write(trace: AnswerTrace): Promise<void>;
}